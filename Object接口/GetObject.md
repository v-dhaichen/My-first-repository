...
>**说明:**
>- 如果 If-None-Match 与 If-Modified-Since 同时携带，If-None-Match 不匹配，If-Modified-Since 匹配，则返回 304 Not Modified。
>- 如果 If-Match 与 If-Unmodified-Since 同时携带，If-Match 匹配，If-Unmodified-Since 不匹配，则返回 200 OK。
